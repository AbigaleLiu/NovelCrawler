...
class Novel(Spider):
    ...
    start_urls = ["http://www.jjwxc.net/onebook.php?novelid=2109567&chapterid=1"]  # 爬取地址
    ...
    def parse(self, response):
        ...
        yield item
        # url跟踪
        url = response.xpath("/html/body/table[@id='oneboolt']/tr[5]/td[@class='noveltitle']/span/a[last()]/@href").extract()
        if url:
